    ...
    conn.ev.on('connection.update', async (update) => {
      ...
      if (connection === 'close') {
        ...
        try {
          ...
          let up = `*✨ *ＷＥＬＣＯＭＥ ᴛᴏ 『NOVA-XMD』* ✨  
*Your bot is now successfully connected!* 👋😎

🔥 *Keep enjoying the power of 『NOVA-XMD』*  
...
━━━━━━━━━━━━━━━━━━
© NOVA-XMD 💓`;
    conn.sendMessage(conn.user.id, { image: { url: `https://github.com/novaxmd/BMB-XMD-DATA/raw/refs/heads/main/nova%20tech.jpg` }, caption: up })
...
setInterval(async () => {
    if (config.AUTO_BIO === "true") {
        ...
        const bioText = `❤️ nova xmd bot 🤖 is alive now\n📅 ${date}\n⏰ ${time}`;
        try {
